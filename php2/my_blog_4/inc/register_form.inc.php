...
<form action="inc/registrierung.php" method="POST" class="registrierung">
    <fieldset>
        ...
        <input type="text" name="nn" placeholder="Nachname eingeben" required>
        <input type="text" name="mail" placeholder="E-Mail eingeben" required>
        <input type="password" name="pwd" placeholder="Passwort eingeben" required>
    </fieldset>
    <fieldset>
