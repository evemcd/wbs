...
//wenn die Variable seite nicht da ist oder der Wert keine Zahl
//dann geh zur Seite 1
if( !isset($seite) || !is_numeric($seite)) {
  $seite = 1;
}
//-----------------
//wenn der Wert der Seite = kleiner als 1 oder größer als Seiten vorhaben (1 2 3 4 5)
//dann geh zur Seite 1
...
<div class="page">
  <?php 
    for($i=1; $i<=$max; $i++) {
      ...
      ?>
      <a href="index.php?page=guestbook&seite=<?= $i ?>">
        <?= $i ?>
      </a>
      <?php
        }//ende else
